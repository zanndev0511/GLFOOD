 ...
 * @author ACER
 */
public class ChatCustomClient extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        customer.setText("Customer Consulting");
        background2.add(customer, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, 300, 30));
    ...
    private void sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "The counselor is not available at the moment, please contact the hotline 0819507689. Thank you.");
        }
    ...
    private void connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectActionPerformed
        try {
            ...
            display.setText(display.getText() + "GLFOOD: Hi, May I help you?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatCustomClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChatCustomClient().setVisible(true);
            }
        });
    }
